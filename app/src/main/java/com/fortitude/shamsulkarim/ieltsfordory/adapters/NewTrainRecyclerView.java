...
import com.fortitude.shamsulkarim.ieltsfordory.data.models.Images;
...
//                        imageView.getHeight(), false));
    ...
    public class DefinationAdapter extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        final StorageReference gsReference = storage.getReferenceFromUrl("gs://fir-userauthentication-f751c.appspot.com/audio/"+wordName+".mp3");
...
//                    tts.speak(wordName, TextToSpeech.QUEUE_ADD, null);
    ...
    public class ImageViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        final ImageView imageQualitySetting;
        final TextView imageText;
        final TextView imageStateText;
        final TextView imageQualitySettingText;
        final TextView reportmistake;
