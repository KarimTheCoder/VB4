...
import com.fortitude.shamsulkarim.ieltsfordory.ui.profile.ProfileViewModel
        ...
        Column(
            ...
            Row(
                ...
                SocialCard(
                    ...
                    onClick = {
                        val intent = Intent(Intent.ACTION_VIEW, Uri.parse(ProfileViewModel.FACEBOOK_URL))
                ...
                SocialCard(
                    ...
                    onClick = {
                        val intent = Intent(Intent.ACTION_VIEW, Uri.parse(ProfileViewModel.INSTAGRAM_URL))
                        context.startActivity(intent)
                    },
                    modifier = Modifier.weight(1f)
                )
