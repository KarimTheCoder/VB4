...
public class JustLearnedDatabaseBeginner extends SQLiteOpenHelper {

    public static final String DATABASE_NAME = "JustLearnedDatabaseBeginner.db";
    ...
    public JustLearnedDatabaseBeginner(Context context) {
