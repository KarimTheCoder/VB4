...
public class JustLearnedDatabaseIntermediate extends SQLiteOpenHelper {



    public static final String DATABASE_NAME = "JustLearnedDatabaseIntermediate.db";
    ...
    public JustLearnedDatabaseIntermediate(Context context) {
